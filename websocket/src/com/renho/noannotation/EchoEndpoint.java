 ...
 */
package com.renho.noannotation;
...
public class EchoEndpoint extends Endpoint {
	...
	public void onOpen(Session session, EndpointConfig endpointConfig) {
		...
		session.addMessageHandler(new EchoMessageHandlerText(
				remoteEndpointBasic));
		session.addMessageHandler(new EchoMessageHandlerBinary(
				remoteEndpointBasic));
	}
	...
	private static class EchoMessageHandlerBinary implements
		...
		private EchoMessageHandlerBinary(
