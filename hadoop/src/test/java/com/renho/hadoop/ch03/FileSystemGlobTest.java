...
public class FileSystemGlobTest {
	...
	public void glob() throws Exception {
		...
		// bug?
		// assertThat(glob("/2007/12/30/data\\[2007-12-30\\]"),
		// is(paths("/2007/12/30/data[2007-12-30]")));
	...
	public void regexIncludes() throws Exception {
		...
		// bug?
		// assertThat(glob("/*/*/*", new RegexPathFilter("^.*/2007/12/31$")),
		// is(paths("/2007/12/31")));
		// this works but shouldn't be necessary? see
		// https://issues.apache.org/jira/browse/HADOOP-3497
	...
	public void testDateRange() throws Exception {
		DateRangePathFilter filter = new DateRangePathFilter(date("2007/12/31"), date("2008/01/01"));
