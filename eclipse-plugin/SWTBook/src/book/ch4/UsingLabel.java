...
public class UsingLabel {
	...
	public static void main(String[] args) {
		...
		final Image image1 = new Image(display,
				UsingLabel.class.getResourceAsStream("image1.bmp"));
		final Image image2 = new Image(display,
				UsingLabel.class.getResourceAsStream("image2.bmp"));
