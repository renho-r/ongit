...
public class ToolBarCoolBar {
	...
	public static void main(String[] args) {
		...
		Image toolBarImage1 = new Image(display,
				UsingToolbar.class.getResourceAsStream("toolbar1.gif"));
		Image toolBarImage2 = new Image(display,
				UsingToolbar.class.getResourceAsStream("toolbar2.gif"));
		Image toolBarImage3 = new Image(display,
				UsingToolbar.class.getResourceAsStream("toolbar3.gif"));
		Image toolBarImage4 = new Image(display,
				UsingToolbar.class.getResourceAsStream("toolbar4.gif"));
		...
		toolBar1.pack();
		coolItem1.setSize(coolItem1.computeSize(toolBar1.getSize().x,
				toolBar1.getSize().y));
		...
		toolBar2.pack();
		coolItem2.setSize(coolItem1.computeSize(toolBar2.getSize().x,
				toolBar2.getSize().y));
