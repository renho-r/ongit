...
$.getScript(protocol + '//c.csdnimg.cn/public/common/tag-suggest-pop/js/main.js?'+(new Date()/120000|0));
})();
                ...
                <div id="cappsarea123" class="icon on-apps-icon">\
                  ...
                  <div class="detail">\
                    <dl>\
                      ...
                      <dd> <a href="http://job.csdn.net?ref=toolbar" target="_blank">JOB<img src="http://c.csdnimg.cn/public/common/toolbar/images/new.gif" style="display: none; margin-top: -26px; width: 23px;"></a></dd>\
