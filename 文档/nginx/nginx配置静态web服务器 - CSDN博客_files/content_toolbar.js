  ...
  var tpl ='\<div class="csdn-toolbar csdn-toolbar tb_disnone'+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix">\
            ...
            <li class="tb_is1150hide"><a href="http://bbs.csdn.net?ref=toolbar" title="论坛" target="_blank">论坛</a></li>\
            <li class="tb_is1210hide"><a href="http://ask.csdn.net?ref=toolbar" title="问答" target="_blank">问答</a></li>\
            <li class="tb_is1270hide"><a href="http://mall.csdn.net?ref=toolbar" title="商城" target="_blank">商城</a></li>\
            <li class="tb_is1330hide"><a href="http://geek.csdn.net?ref=toolbar" title="极客头条" target="_blank">头条</a></li>\
            <li class="show-more">\
            <a href="javascript:;"class="show-more-a"><svg width="22" height="4" xmlns="http://www.w3.org/2000/svg"><path d="M2 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm9 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm9 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" fill="#4F4F4F" fill-rule="evenodd"/></svg></a>\
              <div class="more">\
                <div class="tb_is1150show"><a href="http://bbs.csdn.net?ref=toolbar" target="_blank">论坛</a></div>\
                <div class="tb_is1210show"><a href="http://ask.csdn.net?ref=toolbar" target="_blank">问答</a></div>\
                <div class="tb_is1270show"><a href="http://mall.csdn.net?ref=toolbar" target="_blank">商城</a></div>\
                <div class="tb_is1330show"><a href="http://geek.csdn.net?ref=toolbar" target="_blank">极客头条</a></div>\
  ...
  function goFn(obj,txt){
    ...
    function transform_search_icon(){
      if($('.btn-search').length>0){
        ...
        $('.btn_clear').detach();
        $('.search_bar').append('<a href="//so.csdn.net/so/" target="_blank" class="btn btn-nobg-noborder btn-search"><i class="iconfont-toolbar toolbar-sousuo"></i></a>');
      }
    }
