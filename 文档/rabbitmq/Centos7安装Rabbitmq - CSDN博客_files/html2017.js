  ...
  var tpl ='\<div class="csdn-toolbar csdn-toolbar'+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="col-md-6 pull-left left-menu clearfix">\
            ...
            <li class="show-more">\
            <a href="javascript:;">更多<i class="iconfont icon-xiajiantou"></i></a>\
              <div class="more">\
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            <ul class="btns">\
              <li><a class="" href="http://www.csdn.net/app/?ref=toolbar" target="_blank"><i class="iconfont icon-shouji"></i>下载 CSDN APP</a></li>\
              <li><a class="" href="http://write.blog.csdn.net/postedit?ref=toolbar" target="_blank"><i class="iconfont icon-tianxie"></i>写博客</a></li>\
              ...
              <li class="userLogin">\
                <div class="loginCenter"><a href="http://my.csdn.net?ref=toolbar"><img class="login_img" src="'+currUser.avatar+'"><span class="userName">'+currUser.userNick+'</span><i class="iconfont icon-xiajiantou"></i></a></div>\
