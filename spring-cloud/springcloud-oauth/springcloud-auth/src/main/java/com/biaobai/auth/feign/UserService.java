package com.biaobai.auth.feign;

import com.biaobai.auth.feign.fallback.UserServiceFallbackImpl;
import com.biaobai.auth.vo.UserVo;
import org.springframework.cloud.netflix.feign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;

@FeignClient(name = "biaobai-upms-service", fallback = UserServiceFallbackImpl.class)
