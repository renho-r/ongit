package com.renho.springwebfluxfunction.handler;
...
public class CalculatorHandler {
    ...
    public Mono<ServerResponse> renho(final ServerRequest request) {
        return ServerResponse.ok().body(Mono.just("renho"), String.class);
    }
}
