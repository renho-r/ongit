...
/**
 * This class implement a simulation of a user validation system. It suspend the
 * Thread a random period of time and then returns a random boolean value. We
 * consider that it returns the true value when the user is validated and the
 * false value when it's not
 *
 */
