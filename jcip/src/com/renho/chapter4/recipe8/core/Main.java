package com.renho.chapter4.recipe8.core;
...
import com.renho.chapter4.recipe8.task.Task;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Verify that the periodic tasks no is in execution after the executor
		// shutdown()
		try {
