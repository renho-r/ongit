...
public class MatrixMock {
	 ...
	 * While generates the array, it counts the times that appears the number we
	 * are going to look for so we can check that the CiclycBarrier class does a
	 * good job
	 * 
	 * @param size
	 ...
	 * @param number
	 *            Number we are going to look for
	 */
