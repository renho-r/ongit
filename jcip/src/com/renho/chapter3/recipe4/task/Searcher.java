package com.renho.chapter3.recipe4.task;

import java.util.concurrent.BrokenBarrierException;
import java.util.concurrent.CyclicBarrier;

import com.renho.chapter3.recipe4.utils.MatrixMock;
import com.renho.chapter3.recipe4.utils.Results;
...
public class Searcher implements Runnable {
	 ...
	 *            First row where look for
	 * @param lastRow
	 *            Last row where fook for
	 * @param mock
	 *            Object with the array of numbers
	 * @param results
	 *            Array to store the results
	 * @param number
	 *            Number to look for
	...
	/**
	 * Main method of the searcher. Look for the number in a subset of rows. For
	 * each row, saves the number of occurrences of the number in the array of
	 * results
	 */
	@Override
	public void run() {
