package com.renho.chapter3.recipe3.task;
...
public class Participant implements Runnable {
	 ...
	 * 
	 * @param conference
	 *            VideoConference in which is going to take part off
	 * @param name
	...
	/**
	 * Core method of the participant. Waits a random time and joins the
	 * VideoConference
	 */
	@Override
	public void run() {
