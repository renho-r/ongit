...
public class SnowFlakeTest {
     ...
     * 起始的时间戳
     */
    private final static long START_STMP = 1585203200000L;
    ...
    public synchronized long nextId() {
        ...
        System.out.println("START_STMP: " + START_STMP);
        System.out.println();
        System.out.println();
        System.out.println();
        long c_s = currStmp - START_STMP;
        System.out.println("currStmp - START_STMP: " + c_s);
        System.out.println("c_s << 22: " + (c_s << 22));
