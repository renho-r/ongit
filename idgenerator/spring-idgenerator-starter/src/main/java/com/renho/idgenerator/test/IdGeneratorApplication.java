package com.renho.idgenerator.test;
...
public class IdGeneratorApplication {
    ...
    private static IIdGenerator redisCacheIdGenerator;
    private static IIdGenerator redisMysqlIdGenerator;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("redisCacheIdGenerator: " + redisCacheIdGenerator);
        System.out.println("redisMysqlIdGenerator: " + redisMysqlIdGenerator);
...
//                            id = snowFlakeIdGenerator.get();
//                            System.out.println("18: " + id);
//                            id = snowFlakeIdGenerator.get("st");
//                            System.out.println("16: " + id);
//                            id = snowFlakeIdGenerator.get("et");
//                            System.out.println("18: " + id);
                        }
                        if (null != id) {
                            ids.add(id);
