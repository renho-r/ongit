...
<div class="wrapper">
    ...
    <div class="sidebar" data-color="purple" data-image="resources/materialdashboard/img/sidebar-1.jpg">
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                <li class="active">
                    <a href="resources/materialdashboard/dashboard.html">
                ...
                <li>
                    <a href="resources/materialdashboard/table.html">
                        <i class="material-icons">content_paste</i>
                        <p>Table List</p>
                    </a>
                </li>
                <li>
                    <a href="resources/materialdashboard/typography.html">
                        <i class="material-icons">library_books</i>
                        <p>Typography</p>
                    </a>
                </li>
                <li>
                    <a href="resources/materialdashboard/icons.html">
                        <i class="material-icons">bubble_chart</i>
                        <p>Icons</p>
                    </a>
                </li>
                <li>
                    <a href="resources/materialdashboard/maps.html">
                        <i class="material-icons">location_on</i>
                        <p>Maps</p>
                    </a>
                </li>
                <li>
                    <a href="resources/materialdashboard/notifications.html">
                        <i class="material-icons text-gray">notifications</i>
                        <p>Notifications</p>
                    </a>
                </li>
                <li class="active-pro">
                    <a href="resources/materialdashboard/upgrade.html">
