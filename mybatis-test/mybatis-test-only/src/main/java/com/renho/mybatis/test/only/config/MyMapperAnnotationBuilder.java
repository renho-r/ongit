 ...
 * @since: 1.0.0
 */
public class MyMapperAnnotationBuilder extends MapperAnnotationBuilder {
    ...
    public MyMapperAnnotationBuilder(Configuration configuration, Class<?> type) {
    ...
    private void loadXmlResource() {
        ...
        if (!configuration.isResourceLoaded("namespace:" + type.getName())) {
            ...
            if (inputStream == null) {
                String blogXml = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n" +
                        "<!DOCTYPE mapper\n" +
                        "        PUBLIC \"-//mybatis.org//DTD Mapper 3.0//EN\"\n" +
                        "        \"http://mybatis.org/dtd/mybatis-3-mapper.dtd\">\n" +
                        "<mapper namespace=\"com.renho.mybatis.test.only.mapper.BlogMapper\">\n" +
                        "    <select id=\"selectBlog\" resultType=\"com.renho.mybatis.test.only.domain.po.Blog\">\n" +
                        "    select id, id name, id addr from Blog where id = #{id}\n" +
                        "  </select>\n" +
                        "</mapper>\n";
                inputStream = new ByteArrayInputStream(blogXml.getBytes());
            }
